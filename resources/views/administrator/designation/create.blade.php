        ...
        <div x-data="basic" class="basic" style="border-top: 4px solid #b331c3;">
            <div class="panel">
                <div class="employee_list_header"
                    ...
                    <a class="btn btn-primary" href="{{ route('administrator.designation.list') }}">Designation Lists</a>
                </div>
                <form class="space-y-5" id="designation_create" method="POST">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mt-2">
                                <label for="">Designation <span class="text-danger">*</span></label>
                                <input name="designation" type="text" placeholder="Designation" class="form-input" />
...
@section('scripts')
    <script>
        ...
        $(document).ready(function() {
            $("#designation_create").submit(function(e) {
                e.preventDefault();
                $("#error").text('');
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('administrator.designation.store') }}",
                    data: formData,
                    contentType: false,
                    processData: false,
