        ...
        <div x-data="basic" class="basic" style="border-top: 4px solid #b331c3;">
            <div class="panel">
                <div class="employee_list_header"
                    ...
                    <h4 class="text-lg font-semibold dark:text-white-light" style="margin-top: 5px;margin-left: 6px;">Department
                        List</h4>
                    <a class="btn btn-primary" href="{{ route('administrator.department.create') }}">Create New Department</a>
                </div>
