        ...
        <div x-data="basic" class="basic" style="border-top: 4px solid #b331c3;">
            <div class="panel">
                <div class="employee_list_header"
                    ...
                    <h4 class="text-lg font-semibold dark:text-white-light" style="margin-top: 5px;margin-left: 6px;">Application
                        List</h4>
                    <a class="btn btn-primary" href="{{ route('administrator.application.create') }}">Create Application</a>
                </div>
                <table class="space-y-5 table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>LWOP - Leave w/o Pay</td>
                            <td><b>5</b> - days</td>
                            <td><a href="" class="btn btn-outline-success" style="width: 50%;">Approved</a></td>
                            <td class="d-flex">

                                <a href="apps-invoice-preview.html" class="hover:text-primary mr-3">
                                    <div
                                        class="grid h-10 w-10 place-content-center rounded-md border border-white-dark/20 dark:border-[#191e3a]">
