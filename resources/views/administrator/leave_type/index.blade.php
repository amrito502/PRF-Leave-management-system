        ...
        <div x-data="basic" class="basic" style="border-top: 4px solid #b331c3;">
            <div class="panel">
                <div class="employee_list_header"
                    ...
                    <h4 class="text-lg font-semibold dark:text-white-light" style="margin-top: 5px;margin-left: 6px;">Leave Type
                        List</h4>
                    <a class="btn btn-primary" href="{{ route('administrator.leave_type.create') }}">Create Leave Type</a>
                </div>
