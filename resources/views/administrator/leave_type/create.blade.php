    ...
    <div x-data="basic" class="basic" style="border-top: 4px solid #b331c3;">
        <div class="panel">
            <div class="employee_list_header" style="background: #ededed!important;padding: 5px 5px;margin-bottom: 10px;border-radius: 6px;">
                ...
                <a class="btn btn-primary" href="{{ route('administrator.leave_type.list') }}">Leave Type Lists</a>
            </div>
               ...
               <div class="row">
                ...
                <div class="col-md-12">
                    <div class="mt-2">
                        ...
                        <input type="text" placeholder="Code" class="form-input"/>
                    </div>
                    ...
                    <div class="mt-2">
                        <label for="">Default Credits <span class="text-danger">*</span></label>
                        <input type="number" placeholder="Default Credits" class="form-input"/>
                    </div>

                    <div class="mt-2">
                        <label for="">Description <span class="text-danger">*</span></label>
                        <textarea name="" placeholder="Description" class="form-input" cols="30" rows="4"></textarea>
                    </div>
