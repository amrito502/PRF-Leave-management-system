<nav x-data="sidebar" class="sidebar fixed bottom-0 top-0 z-50 h-full min-h-screen w-[260px] shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-all duration-300">
    <div class="h-full bg-white dark:bg-[#0e1726]">
        <div class="flex items-center justify-between px-4 py-3">
            <a href="{{ route('supervisor.dashboard') }}" class="main-logo flex shrink-0 items-center">
                <img class="ml-[5px] w-8 flex-none" src="{{ asset('assets/images/logo.png') }}" alt="image">
                <span class="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline" style="font-size: 18px;">PRF-Dashboard</span>
            </a>
        ...
        <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold" x-data="{ activeDropdown: 'dashboard' }">
            <h2 class="-mx-4 mb-3 flex items-center bg-white-light/30 px-7 py-3 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
            ...
            <li class="nav-item">
                <a href="" class="group">
                    <div class="flex items-center">
                        ...
                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Employees List</span>
                    </div>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="" class="group">
                    <div class="flex items-center">
                        ...
                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Application List</span>
                    </div>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="" class="group">
                    <div class="flex items-center">
                        ...
                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Department List</span>
                    </div>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a href="apps-calendar.html" class="group">
                    <div class="flex items-center">
                        ...
                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Designation List</span>
                    </div>
                </a>
            </li>
