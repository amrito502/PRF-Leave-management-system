                    ...
                    <div
                        ...
                        <div class="absolute top-6 end-6">
                            <div class="custom-select" style="width:200px;">
                                <select>
                                  ...
                                  <option value="1">Superadmin Login</option>
                                  <option value="1">Admin Login</option>
                                  <option value="1">HR Login</option>
                                  <option value="2">Supervisor Login</option>
                                  <option value="3">Employee Login</option>
                                </select>
                              </div>
                        </div>
                        <!-- script -->
                        ...
                        <div class="mx-auto w-full max-w-[440px]">
                            ...
                            <div class="text-center dark:text-white">
                                Forgotten password?
                                {{-- <a href="auth-boxed-signup.html" class="uppercase text-primary underline transition hover:text-black dark:hover:text-white">Forgotten password?</a> --}}
                            </div>
                        </div>
                    </div>
                </div>
